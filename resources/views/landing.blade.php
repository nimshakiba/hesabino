    ...
    <header class="bg-white shadow py-4 sticky top-0 z-40">
        <div class="container mx-auto flex justify-between items-center px-4">
            <a href="/" class="flex items-center">
                <img src="{{ asset('assets/img/logo.svg') }}" alt="حسابینو" class="h-10 ml-3" />
    ...
    <section class="hero-bg text-white py-20">
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center">
            ...
            <div class="md:w-1/2 flex justify-center">
                <img src="{{ asset('assets/img/hero-dashboard.png') }}" alt="دمو نرم‌افزار حسابداری" class="rounded-xl shadow-xl w-full max-w-md">
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                <div class="bg-blue-50 p-6 rounded-lg shadow hover:shadow-lg transition">
                    <img src="{{ asset('assets/img/invoice.svg') }}" class="h-12 mx-auto mb-4" alt="">
                ...
                <div class="bg-blue-50 p-6 rounded-lg shadow hover:shadow-lg transition">
                    <img src="{{ asset('assets/img/report.svg') }}" class="h-12 mx-auto mb-4" alt="">
                ...
                <div class="bg-blue-50 p-6 rounded-lg shadow hover:shadow-lg transition">
                    <img src="{{ asset('assets/img/warehouse.svg') }}" class="h-12 mx-auto mb-4" alt="">
                ...
                <div class="bg-blue-50 p-6 rounded-lg shadow hover:shadow-lg transition">
                    <img src="{{ asset('assets/img/customers.svg') }}" class="h-12 mx-auto mb-4" alt="">
                ...
                <div class="bg-blue-50 p-6 rounded-lg shadow hover:shadow-lg transition">
                    <img src="{{ asset('assets/img/bank.svg') }}" class="h-12 mx-auto mb-4" alt="">
                ...
                <div class="bg-blue-50 p-6 rounded-lg shadow hover:shadow-lg transition">
                    <img src="{{ asset('assets/img/cloud.svg') }}" class="h-12 mx-auto mb-4" alt="">
